...
| [Roles & Personas](octoacme-roles-and-personas.md) | Detailed responsibilities for PM, PdM, Developers, QA, Release Manager, Documentation Lead, DevOps Engineer, Security Champion, and Customer Experience Advocate |
| [Team Member Onboarding Checklist](octoacme-onboarding-checklist.md) | Week-by-week onboarding guide with role-specific ramp-up tasks and sign-off |
